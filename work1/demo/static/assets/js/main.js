...
var Main = function() {
    var $html = $('html'),
        ...
        MEDIAQUERY = {},
        app = $('#app');
    var url = "https://mediapplication.000webhostapp.com/";
    MEDIAQUERY = {
        desktopXL: 1200,
        desktop: 992,
        tablet: 768,
    ...
    var settingsHandler = function() {
        ...
        $('#skin_color').attr("href", url + "assets/css/themes/" + appSetting.theme + ".css");
        ...
        $('input[name="setting-theme"]').change(function() {
            ...
            $('#skin_color').attr("href", url + "assets/css/themes/" + selectedTheme + ".css");
        ...
        function switchLogo(theme) {
            switch (theme) {
                ...
                case "theme-5":
                case "theme-6":
                    $(".navbar-brand img").attr("src", url + "assets/images/logo2.png");
                    break;

                default:
                    $(".navbar-brand img").attr("src", url + "assets/images/logo.png");
                    break;
            }
        }
        ...
        function defaultSetting() {
            ...
            $('#skin_color').attr("href", url + "assets/css/themes/theme-1.css");
            $(".navbar-brand img").attr("src", url + "assets/images/logo.png");
